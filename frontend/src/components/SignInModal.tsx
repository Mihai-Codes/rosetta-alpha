...
async function handleSignIn(provider: 'google' | 'github', setIsLoading: (v: string | null) => void) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-[#000000] border border-border-strong solid-panel overflow-hidden shadow-none-strong rounded-none"
          >
            ...
            <div className="relative z-30 p-8 sm:p-10">
              ...
              <div className="mb-8 text-left border-b border-border pb-6">
                ...
                <p className="text-text-secondary text-[10.5px] sm:text-xs leading-relaxed font-mono whitespace-nowrap tracking-tight overflow-hidden text-ellipsis">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="group relative w-full flex items-center justify-center gap-4 px-5 py-4 border border-border-strong bg-[#0A0A0A] hover:bg-[#0A0A0A] hover:border-brand-red/60 text-text-primary text-[11px] font-mono uppercase tracking-[0.15em] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  ...
                  <svg className="w-4 h-4 shrink-0 relative z-10 grayscale group-hover:grayscale-0 transition-all duration-300" viewBox="0 0 24 24">
                    ...
                    <path fill="#FFD700" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                    <path fill="#D82B2B" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                  </svg>

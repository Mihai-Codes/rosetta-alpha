    ...
    <div className="flex flex-col items-center gap-4 sm:gap-6 w-full max-w-xs mx-auto">
      <div className="relative flex items-center justify-center w-[200px] h-[200px] mx-auto">
        <svg width="200" height="200" viewBox="0 0 200 200" className="transform -rotate-90 absolute inset-0">
          {/* Track */}
          <circle cx={100} cy={100} r={radius} fill="none" stroke="#0A0A0A" strokeWidth="12" />
          {/* Segments */}
          {QUADRANTS.map((q, i) => {
...
export function DashboardView() {
  ...
  if (!isConnected) {
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-border/60 border border-border/60 rounded-none animate-rain">
        ...
        <div className="lg:col-span-2 bg-[#000000] p-8 sm:p-16 flex flex-col items-center justify-center min-h-[450px] text-center relative overflow-hidden border-r border-border/60">
          ...
          <div className="relative z-10 flex flex-col items-center w-full max-w-md border border-brand-red/20 bg-bg-primary/80 p-8 sm:p-10 shadow-none">
            ...
            <p className="text-text-secondary text-[11px] leading-relaxed mb-8 font-mono text-left w-full border-l-2 border-brand-red/50 pl-4 bg-[#0A0A0A] py-3">
        ...
        <div className="bg-[#000000] p-6 sm:p-10 flex flex-col relative overflow-hidden border-l border-border/60 justify-between">
  ...
  return (
    <div className="space-y-8 sm:space-y-10">
      ...
      <div className="mb-10 solid-panel bg-[#000000] p-6 sm:p-8 border border-border/80 shadow-2xl relative overflow-hidden">
        {/* Subtle top red glow */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-border/60 border border-border/60 rounded-none shadow-2xl">
        ...
        <motion.div
          ...
          className="bg-[#000000] p-6 sm:p-10 flex flex-col gap-6 border-l border-border/60 relative overflow-hidden"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-border/60 border border-border/60 rounded-none">
        ...
        <div className="bg-[#000000] p-6 sm:p-8 flex flex-col justify-center">

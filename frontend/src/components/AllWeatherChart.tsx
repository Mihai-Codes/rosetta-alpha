  ...
  return (
    <div className="glass-panel border border-border/20 rounded-2xl p-5 sm:p-8 shadow-none h-full">
      ...
      <div className="text-center mt-6 pt-5 border-t border-border/50">
        <p className="text-[11px] text-text-tertiary leading-relaxed mx-auto text-center">
          <span className="whitespace-nowrap">Inspired by Bridgewater's <a href="https://www.bridgewater.com/research-and-insights/the-all-weather-story" target="_blank" rel="noopener noreferrer" className="text-brand-red hover:text-text-primary transition-colors font-medium drop-shadow-[0_0_8px_rgba(216,43,43,0.5)]">All Weather strategy</a></span><br/>
          <span className="whitespace-nowrap">balanced exposure across four economic regimes: rising/falling growth and inflation.</span>
        </p>
      </div>
    </div>
  )

...
function heatColor(score: number) {
  ...
  if (score >= 0.75) return 'bg-[#D9822B]/30 border-[#D9822B]/50 text-[#D9822B]'
  return 'bg-[#C9A84C]/20 border-[#C9A84C]/40 text-[#C9A84C]'
}
...
export function ContagionAlert() {
  ...
  return (
    <div className="border border-[#D9822B]/50 bg-[#130A05] shadow-[0_0_40px_rgba(216,43,43,0.08)]">
      <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        >
          <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center border border-[#D9822B]/50 bg-[#D9822B]/10 text-[#D9822B]">
            <AlertTriangle className="h-4 w-4" />
          </span>

          <span className="min-w-0 flex-1">
            <span className="block font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#D9822B]">
            ...
            <span className="mt-2 flex flex-wrap items-center gap-2 font-mono text-[10px] uppercase tracking-[0.16em] text-text-tertiary">
              ...
              <span>·</span>
              <span className="text-[#C9A84C]">ρ {alert.correlation_score.toFixed(2)}</span>
            </span>
          </span>
      ...
      {expanded && (
        <div className="border-t border-[#D9822B]/20 p-4 pt-3">

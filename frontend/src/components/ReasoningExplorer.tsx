        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          {desk.debate_summary && (
            <div className="border border-warning/20 bg-warning/5 p-4">
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-warning mb-2">
                ⚔️ Debate Summary
              </p>
      ...
      <div className="glass-panel border border-border/40 rounded-none p-6 space-y-5">
        ...
        {block.thought_process && (
          <div className="space-y-2">
            ...
            <div className="bg-bg-primary/50 border border-brand-red/20 rounded-none p-4 text-[11px] text-text-secondary leading-relaxed font-mono italic shadow-inner">
              {block.thought_process}
            </div>
          </div>
        )}

      ...
      <div className="relative glass-panel border border-brand-red/30 w-full max-w-4xl max-h-[90vh] rounded-none-none shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-6 border-b border-border/60 flex items-center justify-between bg-bg-secondary/40">
          <div className="flex items-center gap-4">
            <div className="p-2 border border-brand-red/20 bg-brand-red/5 rounded-none-none flex items-center justify-center shadow-glow-red">
      ...
      <div className="glass-panel border border-border/40 rounded-none-none p-6 space-y-5">
        ...
        {block.thought_process && (
          <div className="space-y-2">
            ...
            <div className="bg-bg-primary/50 border border-brand-red/20 rounded-none-none p-4 text-[11px] text-text-secondary leading-relaxed font-mono italic shadow-inner">
              {block.thought_process}
            </div>
          </div>
        )}

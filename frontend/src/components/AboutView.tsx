      ...
      <div className="solid-panel rounded-[2.5rem] p-20 border-white/[0.03] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.6)]">
        ...
        <div className="flex flex-col gap-3 w-full max-w-[1400px] mx-auto">
          {[
            ...
            <div key={i} className="group flex items-center justify-between gap-16 p-5 bg-white/[0.01] border border-white/[0.03] rounded-lg transition-all duration-700 hover:bg-brand-red/[0.01] hover:border-brand-red/10">
              <div className="w-[180px] shrink-0">
                <p className="text-[9px] uppercase tracking-[0.5em] text-brand-red/30 group-hover:text-brand-red transition-all duration-500 font-bold whitespace-nowrap">{item.label}</p>
              </div>
              <div className="w-[280px] shrink-0">
                <p className="text-lg font-display text-text-primary tracking-tight whitespace-nowrap">{item.assets}</p>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[13px] text-text-tertiary font-light whitespace-nowrap overflow-hidden text-ellipsis">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>

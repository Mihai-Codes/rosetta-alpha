      ...
      <div className="solid-panel rounded-[2.5rem] p-20 border-white/[0.03] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.6)]">
        ...
        <div className="flex flex-col gap-2 w-full max-w-[1400px] mx-auto">
          {[
            ...
            <div key={i} className="group flex items-center justify-between gap-10 p-4 bg-white/[0.01] border border-white/[0.03] rounded-lg transition-all duration-700 hover:bg-brand-red/[0.01] hover:border-brand-red/10">
              <div className="w-[160px] shrink-0">
                <p className="text-[9px] uppercase tracking-[0.6em] text-brand-red/40 group-hover:text-brand-red transition-all duration-500 font-bold whitespace-nowrap">{item.label}</p>
              </div>
              <div className="w-[240px] shrink-0 border-l border-white/5 pl-8">
                <p className="text-base font-display text-text-primary tracking-tight whitespace-nowrap">{item.assets}</p>
              </div>
              <div className="flex-1 min-w-0 border-l border-white/5 pl-8">
                <p className="text-[12px] text-text-tertiary font-light whitespace-nowrap">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>

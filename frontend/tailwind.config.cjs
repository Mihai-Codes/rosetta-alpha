  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        primary: { DEFAULT: '#D82B2B', foreground: '#FFFFFFFFFFFF' },
        secondary: { DEFAULT: '#0A0A0A', foreground: '#888888' },
        muted: { DEFAULT: '#0A0A0A', foreground: '#888888' },
        accent: { DEFAULT: '#0A0A0A', foreground: '#FFFFFFFFFFFF' },
        card: { DEFAULT: '#0A0A0A', foreground: '#FFFFFFFFFFFF' },
        popover: { DEFAULT: '#0A0A0A', foreground: '#FFFFFFFFFFFF' },
        destructive: { DEFAULT: '#D82B2B', foreground: '#FFFFFFFFFFFF' },
